...
namespace _Project.Scripts.Infrastructure.Installers
{
    public class BootInstaller : MonoInstaller
    {
        ...
        {
            _assetProvider = new AssetProvider(Container);
        ...
        {
            StatusEffectFactory statusEffectFactory = new();
            SkillFactory skillFactory = new(_configService, statusEffectFactory);

            _gameFactory = new GameFactory(_configService, _assetProvider, _inputService, skillFactory);
